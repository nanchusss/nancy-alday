      ...
      <section className="diagnostic-panel" ref={panelRef}>
        ...
        {screen === "result" && <div className="diagnostic-result">
          ...
          <form className="diagnostic-lead" onSubmit={submitLead}>
            ...
            <details className="diagnostic-privacy"><summary>{copy.privacyInfo}</summary><p>Responsable: NaN Estudio Digital. Finalidad: responder a tu solicitud y enviarte el diagnóstico. No se usarán tus datos para publicidad ni se cederán, salvo a los proveedores técnicos necesarios para prestar el servicio. Puedes solicitar acceso, rectificación o supresión mediante el formulario de contacto.</p></details>
