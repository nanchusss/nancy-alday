  ...
  return <main className={`contact-page contact-${variant}`}>
    ...
    <section>
      ...
      <form className={status === "sent" ? "is-sent" : ""} onSubmit={submit}>
        ...
        <details className="contact-privacy"><summary>Información sobre privacidad</summary><p>Responsable: NaN Estudio Digital. Finalidad: responder a tu solicitud. No se usarán tus datos para publicidad ni se cederán, salvo a proveedores técnicos necesarios. Puedes solicitar acceso, rectificación o supresión mediante este formulario.</p></details>
